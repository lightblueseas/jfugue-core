...
public class Midi2WavUtils
{
     ...
     */
    private static Sequence getSequenceFromPattern(final PatternProducer pattern) throws MidiUnavailableException, InvalidMidiDataException {
     ...
     */
    public static void createWavFile(final PatternProducer pattern, final File outputFile) throws MidiUnavailableException, InvalidMidiDataException, IOException {
     ...
     * to prevent memory problems, this method asks for an array of patches (instruments) to load.
     */
    public static void createWavFile(final PatchProvider patchProvider, final PatternProducer pattern, final File outputFile) throws MidiUnavailableException, InvalidMidiDataException, IOException {
     ...
     * to prevent memory problems, this method asks for an array of patches (instruments) to load.
     */
    public static void createWavFile(final Sequence sequence, final File outputFile) throws MidiUnavailableException, InvalidMidiDataException, IOException {
     ...
     * to prevent memory problems, this method asks for an array of patches (instruments) to load.
     */
    public static void createWavFile(final PatchProvider patchProvider, final Sequence sequence, final File outputFile) throws MidiUnavailableException, InvalidMidiDataException, IOException
    {
        // Open the Synthesizer and load the requested instruments
        final AudioInputStream stream = AudioUtils.getAudioInputStream(sequence, patchProvider, AudioUtils.DEFAULT_AUDIO_FORMAT, AudioUtils.DEFAULT_INFO);
        try {
