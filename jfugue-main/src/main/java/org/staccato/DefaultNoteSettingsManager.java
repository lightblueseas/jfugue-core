...
public class DefaultNoteSettingsManager {
	...
	private boolean defaultAdjustNotesByKeySignature = DEFAULT_DEFAULT_ADJUST_NOTES_BY_KEY_SIGNATURE;
	...
	public void setDefaultAdjustNotesByKeySignature(boolean b) {
	    this.defaultAdjustNotesByKeySignature = b;
	}
