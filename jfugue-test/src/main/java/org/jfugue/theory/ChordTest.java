...
public class ChordTest 
{
    ...
    public void testCreateChordWithInvertedNotes_FourNoteChord_ThirdInversion_AskBassNote() {
        ...
        assertTrue(chord.getBassNote().equals(new Note("B4").setOctaveExplicitlySet(false)));
    }

    @Test
    public void testGetBassNote() {
        Chord chord = new Chord("Cmaj^");
        assertTrue(chord.getBassNote().equals(new Note("E3").setOctaveExplicitlySet(false)));
    }
