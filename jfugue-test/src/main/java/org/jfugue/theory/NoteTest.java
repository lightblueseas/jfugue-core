...
public class NoteTest 
{
    ...
    public void testRestValue() {
        Note rest = new Note("R");
        assertTrue(rest.getValue() == 0);
    }
    
    @Test
    public void testRestOctave() {
        Note rest = new Note("R");
        assertTrue(rest.getOctave() == 0);
    }
    
    @Test
    public void testRestToneString() {
        Note rest = new Note("R");
        assertTrue(rest.getToneString().equals("R"));
    }
    
    @Test
    public void testRestFrequency() {
        System.out.println(Note.getFrequencyForNote("R"));
